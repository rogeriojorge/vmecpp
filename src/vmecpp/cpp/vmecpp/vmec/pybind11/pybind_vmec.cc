...
PYBIND11_MODULE(_vmecpp, m) {
  ...
  py::class_<vmecpp::WOutFileContents>(m, "WOutFileContents")
      ...
      .def_readonly("version", &vmecpp::WOutFileContents::version)
      //
      .def_readonly("sign_of_jacobian",
                    &vmecpp::WOutFileContents::sign_of_jacobian)
      //
      .def_readonly("gamma", &vmecpp::WOutFileContents::gamma)
      //
      .def_readonly("pcurr_type", &vmecpp::WOutFileContents::pcurr_type)
      .def_readonly("pmass_type", &vmecpp::WOutFileContents::pmass_type)
      .def_readonly("piota_type", &vmecpp::WOutFileContents::piota_type)
      //
      .def_readonly("am", &vmecpp::WOutFileContents::am)
      .def_readonly("ac", &vmecpp::WOutFileContents::ac)
      .def_readonly("ai", &vmecpp::WOutFileContents::ai)
      //
      .def_readonly("am_aux_s", &vmecpp::WOutFileContents::am_aux_s)
      .def_readonly("am_aux_f", &vmecpp::WOutFileContents::am_aux_f)
      //
      .def_readonly("ac_aux_s", &vmecpp::WOutFileContents::ac_aux_s)
      .def_readonly("ac_aux_f", &vmecpp::WOutFileContents::ac_aux_f)
      //
      .def_readonly("ai_aux_s", &vmecpp::WOutFileContents::ai_aux_s)
      .def_readonly("ai_aux_f", &vmecpp::WOutFileContents::ai_aux_f)
      //
      .def_readonly("nfp", &vmecpp::WOutFileContents::nfp)
      .def_readonly("mpol", &vmecpp::WOutFileContents::mpol)
      .def_readonly("ntor", &vmecpp::WOutFileContents::ntor)
      .def_readonly("lasym", &vmecpp::WOutFileContents::lasym)
      //
      .def_readonly("ns", &vmecpp::WOutFileContents::ns)
      .def_readonly("ftolv", &vmecpp::WOutFileContents::ftolv)
      .def_readonly("maximum_iterations",
                    &vmecpp::WOutFileContents::maximum_iterations)
      //
      .def_readonly("lfreeb", &vmecpp::WOutFileContents::lfreeb)
      .def_readonly("mgrid_file", &vmecpp::WOutFileContents::mgrid_file)
      .def_readonly("extcur", &vmecpp::WOutFileContents::extcur)
      .def_readonly("mgrid_mode", &vmecpp::WOutFileContents::mgrid_mode)
      //
      .def_readonly("wb", &vmecpp::WOutFileContents::wb)
      .def_readonly("wp", &vmecpp::WOutFileContents::wp)
      //
      .def_readonly("rmax_surf", &vmecpp::WOutFileContents::rmax_surf)
      .def_readonly("rmin_surf", &vmecpp::WOutFileContents::rmin_surf)
      .def_readonly("zmax_surf", &vmecpp::WOutFileContents::zmax_surf)
      //
      .def_readonly("mnmax", &vmecpp::WOutFileContents::mnmax)
      .def_readonly("mnmax_nyq", &vmecpp::WOutFileContents::mnmax_nyq)
      //
      .def_readonly("ier_flag", &vmecpp::WOutFileContents::ier_flag)
      //
      .def_readonly("aspect", &vmecpp::WOutFileContents::aspect)
      //
      .def_readonly("betatot", &vmecpp::WOutFileContents::betatot)
      .def_readonly("betapol", &vmecpp::WOutFileContents::betapol)
      .def_readonly("betator", &vmecpp::WOutFileContents::betator)
      .def_readonly("betaxis", &vmecpp::WOutFileContents::betaxis)
      //
      .def_readonly("b0", &vmecpp::WOutFileContents::b0)
      //
      .def_readonly("rbtor0", &vmecpp::WOutFileContents::rbtor0)
      .def_readonly("rbtor", &vmecpp::WOutFileContents::rbtor)
      //
      .def_readonly("IonLarmor", &vmecpp::WOutFileContents::IonLarmor)
      .def_readonly("VolAvgB", &vmecpp::WOutFileContents::VolAvgB)
      //
      .def_readonly("ctor", &vmecpp::WOutFileContents::ctor)
      //
      .def_readonly("Aminor_p", &vmecpp::WOutFileContents::Aminor_p)
      .def_readonly("Rmajor_p", &vmecpp::WOutFileContents::Rmajor_p)
      .def_readonly("volume_p", &vmecpp::WOutFileContents::volume_p)
      //
      .def_readonly("fsqr", &vmecpp::WOutFileContents::fsqr)
      .def_readonly("fsqz", &vmecpp::WOutFileContents::fsqz)
      .def_readonly("fsql", &vmecpp::WOutFileContents::fsql)
      //
      .def_readonly("iota_full", &vmecpp::WOutFileContents::iota_full)
      .def_readonly("safety_factor", &vmecpp::WOutFileContents::safety_factor)
      .def_readonly("pressure_full", &vmecpp::WOutFileContents::pressure_full)
      .def_readonly("toroidal_flux", &vmecpp::WOutFileContents::toroidal_flux)
      .def_readonly("phipf", &vmecpp::WOutFileContents::phipf)
      .def_readonly("poloidal_flux", &vmecpp::WOutFileContents::poloidal_flux)
      .def_readonly("chipf", &vmecpp::WOutFileContents::chipf)
      .def_readonly("jcuru", &vmecpp::WOutFileContents::jcuru)
      .def_readonly("jcurv", &vmecpp::WOutFileContents::jcurv)
      //
      .def_readonly("iota_half", &vmecpp::WOutFileContents::iota_half)
      .def_readonly("mass", &vmecpp::WOutFileContents::mass)
      .def_readonly("pressure_half", &vmecpp::WOutFileContents::pressure_half)
      .def_readonly("beta", &vmecpp::WOutFileContents::beta)
      .def_readonly("buco", &vmecpp::WOutFileContents::buco)
      .def_readonly("bvco", &vmecpp::WOutFileContents::bvco)
      .def_readonly("dVds", &vmecpp::WOutFileContents::dVds)
      .def_readonly("spectral_width", &vmecpp::WOutFileContents::spectral_width)
      .def_readonly("phips", &vmecpp::WOutFileContents::phips)
      .def_readonly("overr", &vmecpp::WOutFileContents::overr)
      //
      .def_readonly("jdotb", &vmecpp::WOutFileContents::jdotb)
      .def_readonly("bdotgradv", &vmecpp::WOutFileContents::bdotgradv)
      //
      .def_readonly("DMerc", &vmecpp::WOutFileContents::DMerc)
      .def_readonly("Dshear", &vmecpp::WOutFileContents::Dshear)
      .def_readonly("Dwell", &vmecpp::WOutFileContents::Dwell)
      .def_readonly("Dcurr", &vmecpp::WOutFileContents::Dcurr)
      .def_readonly("Dgeod", &vmecpp::WOutFileContents::Dgeod)
      //
      .def_readonly("equif", &vmecpp::WOutFileContents::equif)
      //
      .def_readonly("curlabel", &vmecpp::WOutFileContents::curlabel)
      //
      .def_readonly("potvac", &vmecpp::WOutFileContents::potvac)
      //
      .def_readonly("xm", &vmecpp::WOutFileContents::xm)
      .def_readonly("xn", &vmecpp::WOutFileContents::xn)
      .def_readonly("xm_nyq", &vmecpp::WOutFileContents::xm_nyq)
      .def_readonly("xn_nyq", &vmecpp::WOutFileContents::xn_nyq)
      //
      .def_readonly("raxis_c", &vmecpp::WOutFileContents::raxis_c)
      .def_readonly("zaxis_s", &vmecpp::WOutFileContents::zaxis_s)
      //
      .def_readonly("rmnc", &vmecpp::WOutFileContents::rmnc)
      .def_readonly("zmns", &vmecpp::WOutFileContents::zmns)
      .def_readonly("lmns_full", &vmecpp::WOutFileContents::lmns_full)
      .def_readonly("lmns", &vmecpp::WOutFileContents::lmns)
      .def_readonly("gmnc", &vmecpp::WOutFileContents::gmnc)
      .def_readonly("bmnc", &vmecpp::WOutFileContents::bmnc)
      .def_readonly("bsubumnc", &vmecpp::WOutFileContents::bsubumnc)
      .def_readonly("bsubvmnc", &vmecpp::WOutFileContents::bsubvmnc)
      .def_readonly("bsubsmns", &vmecpp::WOutFileContents::bsubsmns)
      .def_readonly("bsubsmns_full", &vmecpp::WOutFileContents::bsubsmns_full)
      .def_readonly("bsupumnc", &vmecpp::WOutFileContents::bsupumnc)
      .def_readonly("bsupvmnc", &vmecpp::WOutFileContents::bsupvmnc)
      //
      .def_readonly("raxis_s", &vmecpp::WOutFileContents::raxis_s)
      .def_readonly("zaxis_c", &vmecpp::WOutFileContents::zaxis_c)
      //
      .def_readonly("rmns", &vmecpp::WOutFileContents::rmns)
      .def_readonly("zmnc", &vmecpp::WOutFileContents::zmnc)
      .def_readonly("lmnc_full", &vmecpp::WOutFileContents::lmnc_full)
      .def_readonly("lmnc", &vmecpp::WOutFileContents::lmnc)
      .def_readonly("gmns", &vmecpp::WOutFileContents::gmns)
      .def_readonly("bmns", &vmecpp::WOutFileContents::bmns)
      .def_readonly("bsubumns", &vmecpp::WOutFileContents::bsubumns)
      .def_readonly("bsubvmns", &vmecpp::WOutFileContents::bsubvmns)
      .def_readonly("bsubsmnc", &vmecpp::WOutFileContents::bsubsmnc)
      .def_readonly("bsubsmnc_full", &vmecpp::WOutFileContents::bsubsmnc_full)
      .def_readonly("bsupumns", &vmecpp::WOutFileContents::bsupumns)
      .def_readonly("bsupvmns", &vmecpp::WOutFileContents::bsupvmns);
